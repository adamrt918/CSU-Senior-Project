...
bool LTexture::loadFromFile(std::string path, SDL_Renderer* gRenderer, int w, int h){
    //Get rid of preexisting texture
    free();
    ...
    {
        //get the scale
        int scaleX = w / loadedSurface->w;
        
        //Render the image stretched
        lRect = {0,0, loadedSurface->w * scaleX, loadedSurface->h * scaleX};
